...
console.log(today.getTime() + " DESPUES DE SET HOURS");
const hotelList = [
  {
    slug: "la-bamba-de-areco",
    name: "La Bamba de Areco",
    photo: "./img/la-bamba-de-areco.jpg",
    description:
  ...
  //   photo: "./img/rincon-del-socorro.jpg",
  //   description:
  ...
  //   photo: "./img/luma-casa-de-montana.jpg",
  //   description:
  ...
  //   photo: "./img/tierra-patagonia.jpg",
  //   description:
